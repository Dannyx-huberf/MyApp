...
const tasks = JSON.parse(localStorage.getItem('yearly_tasks')) || [];
...
function saveTasks() {
    ...
    localStorage.setItem('yearly_tasks', JSON.stringify(tasksToSave));
...
function clearTasks(){
    ...
    localStorage.removeItem('yearly_tasks');
    handleTaskChange(); // Update pending tasks count
}
